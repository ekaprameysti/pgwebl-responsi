...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" mimeType="" name="File Geodatabase Feature Class" type="Local Area Network" description="" size="" url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb"/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial minx="0" minz="0" maxz="0" crs="EPSG:4326" miny="0" dimensions="2" maxy="0" maxx="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
